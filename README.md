...
| 29.09.23 | Scikit-learn (классификаторы). Оптическое распознавание текстов (Tessaract). |         |         | [Scikit-learn и распознавание текстов (Tessaract).](https://colab.research.google.com/drive/156hCld7hJGIJnA41qNwizKZUxfQkdyPP?usp=sharing) |
| 06.10.23 |||||
||||||
||||||
||||||
